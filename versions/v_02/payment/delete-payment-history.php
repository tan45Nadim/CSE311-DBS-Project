...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4>Patient Details 
                    <a href="../patient/search-patient.php" class = "btn btn-success float-end">Search Patient</a>
                </h4>
            </div>
            <div class="card-body">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody align="center">  
                        <?php
                            $searched_p_id = $_GET['search_p_id'];
                            
                            if ($searched_p_id) {
                                $query = "SELECT visit_count, p_id, purpose_name, payable_amount, paid
                                    FROM payment_history, purpose
                                    WHERE payment_history.purpose_id = purpose.purpose_id AND p_id = '$searched_p_id' ";
                            } else {
                                $query = "SELECT visit_count, p_id, purpose_name, payable_amount, paid
                                    FROM payment_history, purpose
                            ...
                            if (mysqli_num_rows($query_run) > 0) {
                                foreach ($query_run as $patient) {
                                    ...
                                    <tr>
                                        ...
                                        <td> <?= $patient['paid']; ?> </td>
                                        <td>
                                            <a href="../patient/view-patient.php?p_id=<?= $patient['p_id']; ?>" class="btn btn-info btn-sm">View</a>
                                            <form action="../roots/source-codes.php" method="POST" class="d-inline">
