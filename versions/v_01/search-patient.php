                            ...
                            if (mysqli_num_rows($query_run) > 0) {
                                foreach ($query_run as $patient) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="view-patient.php?p_id=<?= $patient['p_id']; ?>" class="btn btn-info stn-sm">View</a>
                                            <a href="update-patient.php?p_id=<?= $patient['p_id']; ?>" class="btn btn-warning stn-sm">Update</a>
                                        </td>
                                    </tr>
                                    <?php
                                }
