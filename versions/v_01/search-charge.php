...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4>Charge Details 
                    <a href="add-charge.php" class = "btn btn-success float-end">Add Charge</a>
                </h4>
            </div>
            <div class="card-body">
                            ...
                            if (mysqli_num_rows($query_run) > 0) {
                                foreach ($query_run as $charge) {
                                    ...
                                    <tr>
                                        ...
                                        <td> <?= $charge['amount']; ?> </td>
                                        <td>
                                            <a href="update-charge.php?charge_num=<?= $charge['charge_num']; ?>" class="btn btn-warning stn-sm">Update</a>
                                        </td>
                                    </tr>
                                    <?php
                                }
