                    ...
                    ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                <p class="h6">Previously Paid (BDT)</p>
                                <input type="number" name="paid_amount" class="form-control mb-3" value="<?=$dataTuple['paid']?>" readonly>
                            </div>
                            <?php
                                ...
                                $query_run = mysqli_query($connect, $query);
                                $dataTuple2 = mysqli_fetch_assoc($query_run);

                            ?>
                            
                            <div class="col-md-3 mb-3">
                                <p class="h6">Due (BDT)</p>
                                <input type="number" name="due_amount" class="form-control mb-3"  value="<?=$dataTuple2['due']?>" readonly>
                            </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-md-3 mb-3">
                                <p class="h6">Adjust Due</p>
                                <input type="number" name="adjust_due" class="form-control mb-3" placeholder="Enter Paid Amount" required>
                            </div>

                            <div class="col-md-3 mb-3">
                                <p class="h6">&nbsp</p>
                                <button type="submit" name="update_payment" class="btn btn-primary">Update Due</button>
                            </div>
